...
<div class="row">
	<div class="primary col-sm-8 space-below">
			...
			<div class="col-md-8">
				...
				<div class="row">
					...
					<div class="col-sm-4 sm-text-right"> 
						...
						<?php if ('' !== get_field('base_price_amount')) { 
							$currency_code = get_field( 'base_price_currency' );
							$base_price = get_field( 'base_price_amount' );

							if ( "0" === $base_price ) {
								echo 'Event is <strong>FREE</strong>';
							} elseif ($base_price) {

								$formatter = new NumberFormatter( 'en', NumberFormatter::CURRENCY );
								echo 'Tickets from <span class="h4">' . $formatter->formatCurrency($base_price, $currency_code) . '&nbsp;<small>' . $currency_code . '</small></span>';
							}
					...
					<div class="col-sm-4">
						...
						<?php  
						$location_terms = wp_get_object_terms( $post->ID,'ibde-location', array ('orderby' => 'term_group', 
							'order' => 'DESC', 
							'fields' => 'all',
							));
